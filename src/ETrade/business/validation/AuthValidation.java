package ETrade.business.validation;
...
public class AuthValidation {
	...
	public static boolean userValidator(User user) {
		boolean result = true;
		boolean[] errors = {emailValidation(user.getEmail()),passwordValidation(user.getPassword()),
				firstNameValidation(user.getFirstName()),lastNameValidation(user.getLastName())};
	...
	public static boolean emailPasswordValidation(String email,String password) {
		boolean result=true;
